...
module.exports = options => {
  ...
  const docOptions = options.swagger.docs;
  const definitionsPrefix = (docOptions.basePath + options.swagger.pathPrefix).replace(/\//g, '');
  ...
  const definitions = swaggerDefinitions(definitionsPrefix);
